...
class AuthColors {
  ...
  static const Color headingText = Color(0xFF131615); // Dark Slate (Figma #131615)
  static const Color subText = Color(0xFF4A5550); // Medium Slate (Figma #4A5550)
  static const Color labelText = Color(0xFF334155); // Slate
  static const Color inputBackground = Color(0xFFFFFFFF); // White
  static const Color inputBorder = Color(0x332D6C50); // Light Border (Figma rgba(45, 108, 80, 0.2))
...
class AppDimensions {
  ...
  static const double primaryButtonTextSize = 18.0; // "Sign In" & "Join the Community"
